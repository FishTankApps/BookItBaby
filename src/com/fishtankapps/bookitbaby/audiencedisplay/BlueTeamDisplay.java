...
public class BlueTeamDisplay extends JComponent {
	...
	public void paintComponent(Graphics graphics) {
		...
		g.drawImage(ImageManager.BLUE_TEAM_BACKGROUND, 0, 0, 
				ImageManager.BLUE_TEAM_BACKGROUND.getWidth(),
				ImageManager.BLUE_TEAM_BACKGROUND.getHeight(), null);
	...
	private void drawTeamName(Graphics2D g) { 
	    ...
	    topLineTransform.translate(10, 35);
	    ...
	    g.drawString(teamNameLines[0],    10, 35);
		g.drawString(teamNameLines[1],    20, 79);
		
		g.setTransform(backup);
	}
	private String[] getTeamNameLines(FontMetrics fm) {
		String[] teamNameParts = manager.getBlueTeamName().split("\\s");
		String topLine = "";
		String bottomLine = "";
		int i;
	...
	private void drawTeamScore(Graphics2D g) {
		...
		String score = Integer.toString(manager.getBlueTeamScore());
	    ...
	    g.setColor(manager.isRedBuzzedIn() ? Color.GRAY : Color.WHITE);
